...
HELP_GUIDES = (
    ...
    {'slug': 'uno-q-dot-test', 'title': 'UNO Q dot test', 'file': 'uno-q-dot-test.md', 'description': 'Use the installed diagnostic core to isolate receiver X/Y input from game movement behavior.', 'group': 'Technical documentation'},
