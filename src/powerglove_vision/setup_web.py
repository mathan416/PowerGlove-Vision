...
<div id=pair-code-fields><p>On the RetroPie console named above, open a terminal and run:</p><pre><code>sudo /opt/powerglove/bin/powerglove-pair</code></pre><label>RetroPie one-time code<input id=pair-code autocomplete=off placeholder=ABCDE-FGHIJ-23456-7ABCD></label><p>This code comes from that RetroPie console, remains valid for five minutes, and is different from the six-digit Controller approval PIN.</p></div>
