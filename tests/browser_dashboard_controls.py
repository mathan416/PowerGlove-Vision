...
async def main():
 ...
 async with async_playwright() as p:
  ...
  async def route(r):
   ...
   if path=='/status':return await r.fulfill(json=dict(vision_state='active',active_profile='super_glove_ball',connection_configured=True,controller_enabled=False,calibrated=True,player={'needs_center':True}))
