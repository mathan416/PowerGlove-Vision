...
| Curl the thumb | <img src="images/gestures/actions/thumb-curl.png" alt="Curl the thumb" width="72"> | B button; see the [Joust play card](GAMEPLAY_GUIDE.md#joust) for its in-game use |
...
| Curl the thumb | <img src="images/gestures/actions/thumb-curl.png" alt="Curl the thumb" width="72"> | Pulsed B |
| Curl the index finger | <img src="images/gestures/actions/finger-curl.png" alt="Curl the index finger" width="72"> | Pulsed A |
