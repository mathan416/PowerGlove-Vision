...
## Try release candidate v0.4.0-rc.4

Release candidate **v0.4.0-rc.4** is intended for users who want to try the new
...
```sh
curl -fLO https://github.com/mathan416/PowerGlove-Vision/releases/download/v0.4.0-rc.4/install-retropie.sh && bash install-retropie.sh --development v0.4.0-rc.4
```

Verify both report `v0.4.0-rc.4`, then follow the pairing/first-game checks below.
